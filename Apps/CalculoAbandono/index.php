  ...
  <body>
    ...
    <?php
      ...
      <div class="row">
        ...
        <div class="col-sm-2">
          <button class="btn btn-lg btn-primary btn-block" type="submit"> <i class="fa fa-floppy-o fa-fw"></i> Calcular y guardar</button>
        </div>
        </form>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-2">
          <a href="informeExcel.php" class="btn btn-lg btn-success" type="button" name="excel"> Descargar informe <br> en EXCEL</a>
        </div>
      </div>
