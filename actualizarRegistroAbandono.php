...
if ($obj->f_ingreso != $ingreso || $obj->f_salida != $salida) {
    var_dump($obj);
  ...
  $sql = "UPDATE registroabandono SET  expediente = '$expediente', claveUnica ='$claveUnica', f_ingreso = '$ingreso', guiaMaster = '$guiaMaster', 
                guiaHouse = '$guiaHouse', piezas ='$piezas', peso = '$peso', descripcion = '$descripcion', f_salida='$salida', diasTotales = '$diasTotales', 
                estatus = '$estatus', derechos = '$derechos', excepcion = '$excepcion', Oficio_idOficio = '$idOficio'
                  WHERE idRegistroAbandono = '$id'";                      
}else {
    $sql = "UPDATE registroabandono SET  expediente = '$expediente', claveUnica ='$claveUnica',  guiaMaster = '$guiaMaster', 
                guiaHouse = '$guiaHouse', piezas ='$piezas', peso = '$peso', descripcion = '$descripcion',
                estatus = '$estatus', excepcion = '$excepcion', Oficio_idOficio = '$idOficio'
                  WHERE idRegistroAbandono = '$id'";
}
$resultado = $mysqli->query($sql);
      ...
      <div class="row" style="text-align:center">
        <?php if($resultado) { ?>
          ...
          <?php header( 'Location: oficio.php?id='.$idOficio.'' ); 
            ...
            echo "Multiplicador: ".$pesoC." Días totales en almacen: ".$diasTemp." Inciso a)".$derechos1."  Inciso b)".$derechos2." Inciso c)".$derechos3." Suma:".$derechos; ?>
